...
public class ContactDto implements Serializable {
  ...
  public ContactDto vatNumber(String vatNumber) {
  ...
  **/
   ...
   * @return the ContactDto instance itself
   */
  public ContactDto putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.vatNumber, contactDto.vatNumber)&&
        Objects.equals(this.additionalProperties, contactDto.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(vatNumber, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ContactDto>() {
           ...
           public ContactDto read(JsonReader in) throws IOException {
             ...
             ContactDto instance = thisAdapter.fromJsonTree(jsonObj);
