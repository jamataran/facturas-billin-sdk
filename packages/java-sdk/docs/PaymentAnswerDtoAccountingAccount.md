...
# PaymentAnswerDtoAccountingAccount
...
|------------ | ------------- | ------------- | -------------|
|**id** | **String** | Unique ID of the accounting account that is related to the payment |  |
|**alias** | **String** | Alias of the accounting account that is related to the payment |  |
