...
|------------ | ------------- | ------------- | -------------|
|**id** | **String** | Unique ID of the accounting account |  [optional] |
|**createdAt** | **OffsetDateTime** | The date when the accounting account was created |  [optional] |
|**updatedAt** | **OffsetDateTime** | The date when the accounting account was last updated |  [optional] |
...
|**isAutomaticConnected** | **Boolean** | Whether the account is automatically connected (true) or manual (false) |  [optional] |
