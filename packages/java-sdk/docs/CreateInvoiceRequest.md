...
|**taxLines** | [**List&lt;DocumentTaxLineBaiDto&gt;**](DocumentTaxLineBaiDto.md) | Tax lines of the document. If not provided, they will be calculated from the lines |  [optional] |
...
|**lines** | [**List&lt;DocumentLineBaiDto&gt;**](DocumentLineBaiDto.md) | Lines of the document |  |
...
|**contact** | [**DocumentContactBaiDto**](DocumentContactBaiDto.md) |  |  |
...
|**taxRegime** | [**TaxRegimeEnum**](#TaxRegimeEnum) | The tax regime of the operation |  [optional] |
|**naturalPerson** | **Boolean** | (Bizkaia businesses) The counterparty is a natural person |  [optional] |
