...
|**id** | **String** | Id of the created contact |  [optional] |
|**createdAt** | **OffsetDateTime** | The date when the contact was created |  [optional] |
|**updatedAt** | **OffsetDateTime** | The date when the contact was last updated |  [optional] |
|**paymentMethods** | **List&lt;ContactPaymentMethod&gt;** | An array of objects, where each object represents a payment method to be associated with the contact. Currently, only the DIRECT_DEBIT type is supported. |  [optional] |
