...
|**dueDate** | **String** | Due date of the invoice |  [optional] |
|**additionalExpenses** | [**List&lt;AdditionalExpenseDto&gt;**](AdditionalExpenseDto.md) | Additional expenses of the invoice |  [optional] |
|**templateId** | **String** | The id of the template to use for the invoice |  [optional] |
|**contact** | [**DocumentContactDto**](DocumentContactDto.md) |  |  |
|**showPdfLinesWithoutTaxes** | **Boolean** | Check this if you want to show the lines without taxes in the PDF visualization in Billin&#39;s web app |  [optional] |
