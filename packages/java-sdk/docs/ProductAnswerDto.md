...
|**createdAt** | **OffsetDateTime** | The date when the product was created |  |
|**updatedAt** | **OffsetDateTime** | The date when the product was last updated |  |
|**marginPercentage** | **BigDecimal** | Margin percentage of gross profit |  |
