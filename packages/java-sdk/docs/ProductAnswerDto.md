...
|**id** | **String** | Id of the created product |  [optional] |
|**createdAt** | **OffsetDateTime** | The date when the product was created |  [optional] |
|**updatedAt** | **OffsetDateTime** | The date when the product was last updated |  [optional] |
|**marginPercentage** | **BigDecimal** | Margin percentage of gross profit |  [optional] |
