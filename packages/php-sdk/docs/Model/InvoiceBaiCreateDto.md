...
**due_date** | **string** | Due date of the invoice | [optional]
**additional_expenses** | [**\FacturasBillin\SDK\Model\AdditionalExpenseDto[]**](AdditionalExpenseDto.md) | Additional expenses of the invoice | [optional]
**template_id** | **string** | The id of the template to use for the invoice | [optional]
**contact** | [**\FacturasBillin\SDK\Model\DocumentContactBaiDto**](DocumentContactBaiDto.md) | Contact of the invoice |
