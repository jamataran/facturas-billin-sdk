...
**due_date** | **string** | Due date of the quote | [optional]
**additional_expenses** | [**\FacturasBillin\SDK\Model\AdditionalExpenseDto[]**](AdditionalExpenseDto.md) | Additional expenses of the quote | [optional]
**template_id** | **string** | The id of the template to use for the quote | [optional]
**contact** | [**\FacturasBillin\SDK\Model\DocumentContactDto**](DocumentContactDto.md) | Contact of the quote |
**show_pdf_lines_without_taxes** | **bool** | Check this if you want to show the lines without taxes in the PDF visualization in Billin&#39;s web app | [optional]
**status** | **string** | Status of the quote | [optional] [default to 'PENDING']
