...
class DefaultApi
{
     ...
     * @return \FacturasBillin\SDK\Model\Ping200Response
     */
     ...
     * @throws \FacturasBillin\SDK\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FacturasBillin\SDK\Model\Ping200Response, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\FacturasBillin\SDK\Model\Ping200Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\FacturasBillin\SDK\Model\Ping200Response';
        $request = $this->pingRequest($contentType);
