...
/**
 * RequestTokenUserApiCredentialDto Class Doc Comment
 *
 * @category Class
 * @package  FacturasBillin\SDK
 * @author   OpenAPI Generator team
 ...
 */
class RequestTokenUserApiCredentialDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestTokenUserApiCredentialDto';
    ...
    */
     ...
     * Sets grant_type
     *
     * @param string|null $grant_type 'client_credentials' is the default value if this field is omitted. 'password' value is only allowed for highly trusted applications
     *
     * @return self
     */
     ...
     * Sets username
     *
     * @param string|null $username Required if grantType is 'password'
     *
     * @return self
     */
     ...
     * Sets password
     *
     * @param string|null $password Required if grantType is 'password'
     *
     * @return self
     */
