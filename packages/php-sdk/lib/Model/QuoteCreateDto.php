...
/**
 * QuoteCreateDto Class Doc Comment
 *
 * @category Class
 * @package  FacturasBillin\SDK
 * @author   OpenAPI Generator team
 ...
 */
class QuoteCreateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QuoteCreateDto';
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if (($code > 1000000000)) {
            throw new \InvalidArgumentException('invalid value for $code when calling QuoteCreateDto., must be smaller than or equal to 1000000000.');
        }
        if (($code < 0)) {
            throw new \InvalidArgumentException('invalid value for $code when calling QuoteCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setMask($mask)
    {
        ...
        if (($mask > 1000000000)) {
            throw new \InvalidArgumentException('invalid value for $mask when calling QuoteCreateDto., must be smaller than or equal to 1000000000.');
        }
        if (($mask < 0)) {
            throw new \InvalidArgumentException('invalid value for $mask when calling QuoteCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setLines($lines)
    {
        ...
        if ((count($lines) < 1)) {
            throw new \InvalidArgumentException('invalid length for $lines when calling QuoteCreateDto., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets due_date
     *
     * @param string|null $due_date Due date of the quote
     *
     * @return self
     */
     ...
     *
     * @param \FacturasBillin\SDK\Model\AdditionalExpenseDto[]|null $additional_expenses Additional expenses of the quote
     *
     * @return self
     */
     ...
     * Sets template_id
     *
     * @param string|null $template_id The id of the template to use for the quote
     *
     * @return self
     */
     ...
     * Sets contact
     *
     * @param \FacturasBillin\SDK\Model\DocumentContactDto $contact Contact of the quote
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Status of the quote
     *
     * @return self
     */
