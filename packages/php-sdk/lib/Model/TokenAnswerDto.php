...
/**
 * TokenAnswerDto Class Doc Comment
 *
 * @category Class
 * @package  FacturasBillin\SDK
 * @author   OpenAPI Generator team
 ...
 */
class TokenAnswerDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TokenAnswerDto';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['expire_in'] === null) {
            $invalidProperties[] = "'expire_in' can't be null";
        }
     ...
     * Sets expire_in
     *
     * @param float $expire_in expire_in
     *
     * @return self
     */
