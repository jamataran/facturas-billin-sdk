...
class InvoiceCreateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if (($code > 1000000000)) {
            throw new \InvalidArgumentException('invalid value for $code when calling InvoiceCreateDto., must be smaller than or equal to 1000000000.');
        }
        if (($code < 0)) {
            throw new \InvalidArgumentException('invalid value for $code when calling InvoiceCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setMask($mask)
    {
        ...
        if (($mask > 1000000000)) {
            throw new \InvalidArgumentException('invalid value for $mask when calling InvoiceCreateDto., must be smaller than or equal to 1000000000.');
        }
        if (($mask < 0)) {
            throw new \InvalidArgumentException('invalid value for $mask when calling InvoiceCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setLines($lines)
    {
        ...
        if ((count($lines) < 1)) {
            throw new \InvalidArgumentException('invalid length for $lines when calling InvoiceCreateDto., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets contact
     *
     * @param \FacturasBillin\SDK\Model\DocumentContactDto $contact Contact of the invoice
     *
     * @return self
     */
